...
hl.bind(vars.kbCommunicationWs, hl.dsp.exec_cmd("caelestia toggle communication && equibop"))
...
-- Volume
hl.bind("XF86AudioMicMute", hl.dsp.exec_cmd("wpctl set-mute @DEFAULT_AUDIO_SOURCE@ toggle; if wpctl get-volume @DEFAULT_AUDIO_SOURCE@ | grep -q '\\[MUTED\\]'; then brightnessctl -d platform::micmute set 1; else brightnessctl -d platform::micmute set 0; fi"), { locked = true })
